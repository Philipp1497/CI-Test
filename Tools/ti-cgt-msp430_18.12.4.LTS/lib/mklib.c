...
library_t LIBRARIES[] = {
    ...
    { "rts430x_sc_sd_eabi_se.lib", { "SMALL_CODE","MSPX","SMALL_ENUM","SMALL_DATA" } },
    { "rts430_eabi.lib", {  } },
    { "rts430x_lc_rd_eabi_se.lib", { "RESTRICTED_DATA","SMALL_ENUM","MSPX" } },
    { "rts430x_lc_ld_eabi_se.lib", { "LARGE_DATA","SMALL_ENUM","MSPX" } },
    { "rts430x_lc_rd_eabi_se_eh.lib", { "RESTRICTED_DATA","SMALL_ENUM","EABI_TDEH","EXCEPTIONS","MSPX" } },
    { "rts430x_lc_ld_eabi_se_eh.lib", { "LARGE_DATA","EABI_TDEH","SMALL_ENUM","MSPX","EXCEPTIONS" } },
    { "rts430x_lc_ld_eabi_eh.lib", { "EXCEPTIONS","MSPX","EABI_TDEH","LARGE_DATA" } },
    { "rts430x_sc_sd_eabi_eh.lib", { "EABI_TDEH","SMALL_DATA","MSPX","SMALL_CODE","EXCEPTIONS" } },
    { "rts430x_lc_ld_eabi.lib", { "LARGE_DATA","MSPX" } },
    { "rts430x_lc_rd_eabi_eh.lib", { "EABI_TDEH","RESTRICTED_DATA","MSPX","EXCEPTIONS" } },
    { "rts430x_lc_rd_eabi.lib", { "RESTRICTED_DATA","MSPX" } },
    { "rts430x_sc_sd_eabi_se_eh.lib", { "EXCEPTIONS","SMALL_CODE","MSPX","SMALL_ENUM","SMALL_DATA","EABI_TDEH" } },
    { "rts430x_lc_sd_eabi_se.lib", { "MSPX","SMALL_ENUM" } },
    { "rts430x_lc_sd_eabi_eh.lib", { "EABI_TDEH","EXCEPTIONS","MSPX" } },
    { "rts430x_lc_sd_eabi_se_eh.lib", { "SMALL_ENUM","EABI_TDEH","EXCEPTIONS","MSPX" } },
    { "rts430x_sc_sd_eabi.lib", { "MSPX","SMALL_CODE","SMALL_DATA" } },
    { "rts430_eabi_eh.lib", { "EABI_TDEH","EXCEPTIONS" } },
